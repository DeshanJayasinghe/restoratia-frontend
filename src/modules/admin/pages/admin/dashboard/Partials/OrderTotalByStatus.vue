    ...
    chartInstance = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: (data.value.colors.length ? data.value.colors : palette).map(color => convertHexToRgba(color, 0.82)),
          borderColor: '#ffffff',
          borderWidth: 3,
          hoverOffset: 6,
        }],
  ...
  <VCard class="dashboard-panel" height="380">
    <VCardTitle class="dashboard-panel__header">
      <div class="dashboard-panel__title">
        <VIcon class="dashboard-panel__icon" icon="tabler-clipboard-data" size="20" />
