<script lang="ts" setup>
  ...
  import TableSecret from '@/modules/printer/pages/admin/printAgent/Partials/TableSecret.vue'
  ...
  const headers: TableHeader[] = [
    ...
    { title: t('printer::print_agents.table.agent_id'), value: 'agent_id', sortable: true },
    { title: t('printer::print_agents.table.secret'), value: 'secret', sortable: false },
    { title: t('admin::admin.table.activation'), value: 'is_active', sortable: true },
    { title: t('printer::print_agents.table.last_seen_at'), value: 'last_seen_at', sortable: true },
